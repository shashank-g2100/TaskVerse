...
export function Sidebar(){
	...
	return (
		<aside
        className={`${sidebarOpen ? "w-64" : "w-0"} md:w-64 h-full bg-gray-100  flex-shrink-0 overflow-y-auto transition-all duration-300 border-r border-gray-200`}
      >
            ...
            <div className="space-y-1">
              {/* <Button variant="ghost" className="w-full justify-start gap-2 text-black font-semibold text-" asChild>
                <Link href="/dashboard">
							...
							<Button variant="ghost" className="w-full justify-start gap-2 font-medium text-base" asChild>
								<Link href="/dashboard">
									<div className="flex items-center gap-2">
										<Home className="w-4 h-4 shrink-0 !w-5.5 !h-5.5" />
										<span>Home</span>
									</div>
								</Link>
							</Button>
              ...
              <Button variant="ghost" className="w-full justify-start gap-2 font-medium text-base" asChild>
                <Link href="/dashboard?filter=today">
                  <CheckCircle2 className="w-4 h-4 shrink-0 !w-5.5 !h-5.5" />
                  <span>Today</span>
                </Link>
              </Button>
              <Button variant="ghost" className="w-full justify-start gap-2 font-medium text-base" asChild>
                <Link href="/dashboard?filter=upcoming">
                  <Calendar className="w-4 h-4 shrink-0 !w-5.5 !h-5.5" />
                  <span>Upcoming</span>
                </Link>
              </Button>
              <Button variant="ghost" className="w-full justify-start gap-2 font-medium text-base" asChild>
                <Link href="/dashboard?filter=important">
                  <Star className="w-4 h-4 shrink-0 !w-5.5 !h-5.5" />
                  <span>Important</span>
                </Link>
              </Button>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-1">
                <Button variant="ghost" className="w-full justify-start gap-2" size="sm">
                  <Tag className="w-4 h-4 shrink-0 !w-5.5 !h-5.5 text-blue-500" />
                  <span>Personal</span>
                </Button>
                <Button variant="ghost" className="w-full justify-start gap-2" size="sm">
                  <Tag className="w-4 h-4 shrink-0 !w-5.5 !h-5.5 text-emerald-500" />
                  <span>Work</span>
                </Button>
                <Button variant="ghost" className="w-full justify-start gap-2" size="sm">
                  <Tag className="w-4 h-4 shrink-0 !w-5.5 !h-5.5 text-purple-500" />
                  <span>Health</span>
                </Button>
                <Button
                  variant="ghost"
